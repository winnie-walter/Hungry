...
class _EditProfileState extends State<EditProfile> {
  TextEditingController _text = TextEditingController(text:'wwm@gmail.com');
  
  TextEditingController _phone = TextEditingController(text:'0716910886');
  TextEditingController _fname = TextEditingController(text:'Winnie Walter Muzze');
  TextEditingController _uname = TextEditingController(text:'WWM');
  TextEditingController _address = TextEditingController(text:'Dar es salaam');
            ...
            children: [
              ...
              Container(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if(_text.text.isEmpty || _uname.text.isEmpty|| _fname.text.isEmpty || _phone.text.isEmpty || _address.text.isEmpty ){
                  ...
                  child: Text('Update', style: TextStyle(color: AppColor.secondary, fontSize: 16, fontWeight: FontWeight.w600, fontFamily: 'inter')),
