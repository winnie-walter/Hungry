      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text('${widget.label}', style: TextStyle(color: AppColor.primary, fontSize: 12)),
          ),
          Container(
            margin: EdgeInsets.only(top: 6),
            width: MediaQuery.of(context).size.width,
            padding: EdgeInsets.all(16),
            color: widget.valueBackground ?? AppColor.primaryExtraSoft,
            child: Text('${widget.value}', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, fontFamily: 'inter')),
          )
        ],
      ),
    );
