          ...
          child: BottomNavigationBar(
            ...
            items: [
              ...
              (widget.selectedIndex == 3)
                  ? BottomNavigationBarItem(icon: Icon(Icons.settings, color: AppColor.primary), label: '')
                  : BottomNavigationBarItem(icon: Icon(Icons.settings, color: Colors.grey[600]), label: ''),
            ],
          ),
        ),
      ),
